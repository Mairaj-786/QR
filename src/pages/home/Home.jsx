          ...
          <Row className="align-items-center" gutter={[40, 100]}>
            ...
            <Col md={12}>
              <p style={{ textAlign: 'left' }}>
                {' '}
                This is one of the most popular free online QR code generator for for WiFi with millions of already created QR codes. The high resolution of the QR codes and the powerful design options make it one of the best free QR code generators on the web that can be used for commercial and print purposes
              </p>
            </Col>
          </Row>
        </MobileArea>
